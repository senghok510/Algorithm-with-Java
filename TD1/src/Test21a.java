...
public class Test21a {
	...
	public static void main(String[] args) {
		...
		assert(max < 0.003) : ("\nPour n = " + n + " et m = " + m
				+ ", votre méthode cut donne une déviation en norme sup de " + max + " qui dépasse 0.003.\n"
				+ "Il y a sans doute un problème.");
		assert(max < 0.0025) : ("\nPour n = " + n + " et m = " + m
				+ ", votre méthode cut donne une déviation en norme sup de " + max + " qui dépasse 0.0025.\n"
				+ "C'est possible mais peu probable. Recommencez le test.");
		System.out.println("[OK]");
		System.out.println(d instanceof Deck);
	}
}
